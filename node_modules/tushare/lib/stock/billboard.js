...
exports.longPeriodRank = longPeriodRank;
 ...
 * @returns {undefined}
 */
function lhb(options, cb) {
  var defaults = {
    start: (0, _moment2.default)().format('YYYY-MM-DD'),
 ...
 * @returns {undefined}
 */
function blockTrade(options, cb) {
  var defaults = {
    start: (0, _moment2.default)().format('YYYY-MM-DD'),
    end: (0, _moment2.default)().format('YYYY-MM-DD'),
    pageNo: 1,
 ...
 * @returns {undefined}
 */
function longPeriodRank(options, cb) {
  var defaults = {
    period: 'month',
    pageNo: 1,
    pageSize: 100
